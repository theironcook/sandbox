// Bart Wood May 17, 2019
// This code is an async version of this library: https://github.com/mziccard/node-timsort
// This code allows you to sort using async comparators
// Otherwise, always use the standard array.sort function in JavaScript
...
class TimSort {
  ...
  */
  async mergeAt(i) {
    ...
    */
    let k = await gallopRight(array[start2], array, start1, length1, 0, compare);
    start1 += k;
    length1 -= k;
 ...
 * comparator.
 */
export async function asyncTimSort(array, compare, lo, hi) {
